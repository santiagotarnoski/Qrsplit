...
import { QrCode, Zap, Lock, ArrowRight, CheckCircle, Wallet, TrendingUp } from 'lucide-react';
    ...
    <div className="min-h-screen bg-black relative">
      ...
      <div className="relative" style={{ zIndex: 2 }}>
        <section className="relative overflow-hidden">
          <div className="absolute inset-0 bg-[linear-gradient(to_right,#1e293b10_1px,transparent_1px),linear-gradient(to_bottom,#1e293b10_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_110%)]" />
        ...
        <section id="features" data-animate className="py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-white mb-4">¿Por qué QRSplit?</h2>
              <p className="text-xl text-slate-400">La única app de pagos grupales con garantía blockchain</p>
            </div>

            <div className="grid md:grid-cols-3 gap-8">
              <Card 
                className="bg-slate-800/30 border-slate-700 backdrop-blur-sm hover:bg-slate-800/50 transition-all group"
                style={{
              ...
              >
                <CardContent className="p-8">
                  ...
                  <p className="text-slate-400 mb-4">Cálculo automático instantáneo. Todos ven los cambios en tiempo real.</p>
        ...
        <section id="how-it-works" data-animate className="py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-400">Tres pasos simples para pagos grupales garantizados</p>
            </div>
              ...
              <div className="flex flex-col md:flex-row items-center justify-center gap-8">
                <div 
                  ...
                  style={{
                    ...
                    transform: visibleSections.has('how-it-works') ? 'translateY(0)' : 'translateY(40px)',
                ...
                >
                  ...
                  <h3 className="text-2xl font-semibold text-white text-center mb-3">Crea Sesión</h3>
                  <p className="text-slate-400 text-center">Genera un QR code único para tu grupo. Comparte instantáneamente.</p>
                </div>
                ...
                >
                  ...
                  <h3 className="text-2xl font-semibold text-white text-center mb-3">Agrega Items</h3>
                  <p className="text-slate-400 text-center">Todos agregan lo que consumieron. El split se calcula automáticamente.</p>
                </div>
                ...
                >
                  ...
                  <h3 className="text-2xl font-semibold text-white text-center mb-3">Pago Blockchain</h3>
                  <p className="text-slate-400 text-center">Conecta wallet. Ejecuta pago atómico. Todos pagan o nadie paga.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="diferenciador" data-animate className="py-24">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <Card 
              className="bg-slate-800/40 border-purple-500/40 backdrop-blur-sm shadow-2xl shadow-purple-500/30"
              style={{
                opacity: visibleSections.has('diferenciador') ? 1 : 0,
                transform: visibleSections.has('diferenciador') ? 'scale(1)' : 'scale(0.95)',
                transition: 'all 0.8s ease-out 0.5s'
              }}
            >
