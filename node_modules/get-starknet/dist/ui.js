...
let V;
function ce(t, e) {
  return V || (V = document.createElement("a")), V.href = e, t === V.href;
}
function _e(t) {
...
const P = [], we = [], X = [], be = [], Qe = Promise.resolve();
let ue = !1;
function Ue() {
  ue || (ue = !0, Qe.then(De));
}
...
function Ve(t, e, r, s) {
  const { fragment: n, on_mount: o, on_destroy: a, after_update: c } = t.$$;
  n && n.m(e, r), s || de(() => {
    const l = o.map(Ae).filter(Oe);
...
function Xe(t, e, r, s, n, o, a, c = [-1]) {
  ...
  a && a(u.root);
  let h = !1;
  if (u.ctx = r ? r(t, e.props || {}, (d, g, ...y) => {
    const v = y.length ? y[0] : g;
    return u.ctx && n(u.ctx[d], u.ctx[d] = v) && (!u.skip_bound && u.bound[d] && u.bound[d](v), h && He(t, d)), g;
  }) : [], u.update(), h = !0, _(u.before_update), u.fragment = s ? s(u.ctx) : !1, e.target) {
    if (e.hydrate) {
      const d = Ee(e.target);
      u.fragment && u.fragment.l(d), d.forEach(E);
    } else
      u.fragment && u.fragment.c();
    e.intro && Ge(t.$$.fragment), Ve(t, e.target, e.anchor, e.customElement), De();
  }
  Q(l);
}
class Je {
  $destroy() {
    Ze(this, 1), this.$destroy = F;
  }
  $on(e, r) {
...
function ve(t) {
  ...
  return {
    c() {
      e = D("li"), s = K(r), n = T(), u.c(), b(e, "class", "flex justify-between items-center p-3 bg-slate-100 rounded-md cursor-pointer shadow-sm hover:bg-slate-200 transition-colors dark:bg-neutral-800 dark:hover:bg-neutral-700 dark:border-neutral-600 dark:text-white svelte-1mtuslq");
    },
    m(g, y) {
      R(g, e, y), I(e, s), I(e, n), u.m(e, null), o || (a = [
        z(e, "click", h),
        z(e, "keyup", d)
      ], o = !0);
    },
    p(g, y) {
      t = g, l === (l = c(t)) && u ? u.p(t, y) : (u.d(1), u = l(t), u && (u.c(), u.m(e, null)));
    },
    d(g) {
      g && E(e), u.d(), o = !1, _(a);
    }
...
function ye(t) {
  let e, r, s, n = t[20].name + "", o, a, c, l, u, h, d, g, y, v;
  return {
    c() {
      e = D("a"), r = D("li"), s = K("Install "), o = K(n), a = T(), c = D("img"), h = T(), b(c, "alt", l = t[20].name), ce(c.src, u = t[20].icon) || b(c, "src", u), b(c, "class", "w-8 h-8 rounded-full svelte-1mtuslq"), b(r, "class", "flex justify-between items-center p-3 bg-slate-100 rounded-md shadow-sm cursor-pointer hover:bg-slate-200 transition-colors dark:bg-neutral-800 dark:hover:bg-neutral-700 dark:border-neutral-600 dark:text-white svelte-1mtuslq"), b(e, "alt", d = t[20].name + " download link"), b(e, "href", g = t[20].download), b(e, "target", "_blank"), b(e, "rel", "noopener noreferrer"), b(e, "class", "svelte-1mtuslq");
    },
    m(N, p) {
      R(N, e, p), I(e, r), I(r, s), I(r, o), I(r, a), I(r, c), I(e, h), y || (v = [
        z(r, "click", t[14]),
        z(r, "keyup", t[15])
      ], y = !0);
    },
    p(N, p) {
      p & 1 && n !== (n = N[20].name + "") && Be(o, n), p & 1 && l !== (l = N[20].name) && b(c, "alt", l), p & 1 && !ce(c.src, u = N[20].icon) && b(c, "src", u), p & 1 && d !== (d = N[20].name + " download link") && b(e, "alt", d), p & 1 && g !== (g = N[20].download) && b(e, "href", g);
    },
    d(N) {
      N && E(e), y = !1, _(v);
    }
...
function tt(t) {
  let e, r, s, n, o, a, c, l, u, h, d, g, y = t[4], v = [];
  ...
  return {
    c() {
      e = D("div"), r = D("main"), s = D("header"), n = D("h1"), n.textContent = "Connect a wallet", o = T(), a = D("span"), a.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" height="24px" width="24px" viewBox="0 0 24 24" fill="currentColor" class="svelte-1mtuslq"><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12 19 6.41z" class="svelte-1mtuslq"></path></svg>', c = T(), l = D("ul");
    ...
    m(f, x) {
      R(f, e, x), I(e, r), I(r, s), I(s, n), I(s, o), I(s, a), I(r, c), I(r, l);
    ...
    p(f, [x]) {
      if (x & 26) {
        ...
        for (m = 0; m < y.length; m += 1) {
          const O = pe(f, y, m);
          v[m] ? v[m].p(O, x) : (v[m] = ve(O), v[m].c(), v[m].m(l, u));
        }
        for (; m < v.length; m += 1)
          v[m].d(1);
        v.length = y.length;
    ...
    o: F,
    d(f) {
      f && E(e), fe(v, f), fe(p, f), d = !1, _(g);
    }
  };
}
const rt = (t) => t.stopPropagation(), st = (t) => t.stopPropagation();
function it(t, e, r) {
  const s = typeof window < "u" ? window : null;
  let { lastWallet: n = null } = e, { installedWallets: o = [] } = e, { authorizedWallets: a = [] } = e, { discoveryWallets: c = [] } = e, { callback: l = async () => {
  } } = e, { theme: u = null } = e, h = !1, d = async (w) => {
    var G;
    r(1, h = (G = w == null ? void 0 : w.id) != null ? G : !1), await l(w).catch(() => {
    }), r(1, h = !1);
  }, g = "";
  u === "dark" || u === null && (s == null ? void 0 : s.matchMedia("(prefers-color-scheme: dark)").matches) ? g = "dark" : g = "";
  const y = (w) => {
  ...
  return t.$$set = (w) => {
    "lastWallet" in w && r(5, n = w.lastWallet), "installedWallets" in w && r(6, o = w.installedWallets), "authorizedWallets" in w && r(7, a = w.authorizedWallets), "discoveryWallets" in w && r(0, c = w.discoveryWallets), "callback" in w && r(8, l = w.callback), "theme" in w && r(9, u = w.theme);
  }, [
    c,
    h,
    g,
  ...
  return new Promise((a) => {
    ...
    const l = new nt({
      ...
      props: {
        ...
        authorizedWallets: s,
        discoveryWallets: t,
        theme: (o == null ? void 0 : o.theme) === "system" ? null : (u = o == null ? void 0 : o.theme) != null ? u : null
      }
    });
  });
}
...
class i {
  ...
  static compareVersions(e, r, s = !1) {
    ...
    const l = i.map([e, r], (u) => {
      const h = a - i.getVersionPrecision(u), d = u + new Array(h + 1).join(".0");
      return i.map(d.split("."), (g) => new Array(20 - g.length).join("0") + g).reverse();
    });
...
class ke {
  ...
  satisfies(e) {
    ...
    if (Object.keys(e).forEach((c) => {
      const l = e[c];
      typeof l == "string" ? (n[c] = l, o += 1) : typeof l == "object" && (r[c] = l, s += 1);
    }), s > 0) {
      const c = Object.keys(r), l = i.find(c, (h) => this.isOS(h));
      if (l) {
      ...
      if (u) {
        const h = this.satisfies(r[u]);
        if (h !== void 0)
          return h;
      }
    }
    if (o > 0) {
      const c = Object.keys(n), l = i.find(c, (u) => this.isBrowser(u, !0));
      if (l !== void 0)
...
var mt = Object.defineProperty, ht = (t, e, r) => e in t ? mt(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, ft = (t, e, r) => (ht(t, typeof e != "symbol" ? e + "" : e, r), r), me = (t, e, r) => {
  if (!e.has(t))
    throw TypeError("Cannot " + r);
}, j = (t, e, r) => (me(t, e, "read from private field"), r ? r.call(t) : e.get(t)), B = (t, e, r) => {
  if (e.has(t))
    throw TypeError("Cannot add the same private member more than once");
  e instanceof WeakSet ? e.add(t) : e.set(t, r);
}, $ = (t, e, r, s) => (me(t, e, "write to private field"), s ? s.call(t, r) : e.set(t, r), r), H = (t, e, r) => (me(t, e, "access private method"), r);
const wt = [
  {
    id: "argentX",
    name: "Argent X",
...
], bt = () => `${Date.now()}-${Math.floor(Math.random() * (9e12 - 1)) + 1e12}`, Ne = (t) => {
  for (let e = t.length - 1; e > 0; e--) {
    const r = Math.floor(Math.random() * (e + 1));
    [t[e], t[r]] = [t[r], t[e]];
  }
  return t;
}, se = (...t) => (e) => t.reduce((r, s) => r.then(s), Promise.resolve(e));
var q, C, U, ge, ze, W, J;
class Mt {
  constructor(e) {
    B(this, ge), B(this, W), B(this, q, !1), B(this, C, void 0), B(this, U, void 0), ft(this, "value"), $(this, U, e), H(this, W, J).call(this);
  }
  set(e) {
    return !j(this, q) && !H(this, W, J).call(this) ? !1 : (this.delete(), this.value = e, e && ($(this, C, `${j(this, U)}-${bt()}`), localStorage.setItem(j(this, C), e)), !0);
  }
  get() {
    return H(this, ge, ze).call(this), this.value;
  }
  delete() {
    return !j(this, q) && !H(this, W, J).call(this) ? !1 : (this.value = null, j(this, C) && localStorage.removeItem(j(this, C)), !0);
  }
}
q = /* @__PURE__ */ new WeakMap(), C = /* @__PURE__ */ new WeakMap(), U = /* @__PURE__ */ new WeakMap(), ge = /* @__PURE__ */ new WeakSet(), ze = function() {
  ...
  try {
    !j(this, q) && typeof window < "u" && ($(this, C, Object.keys(localStorage).find(
      (t) => t.startsWith(j(this, U))
    )), $(this, q, !0), j(this, C) && this.set(localStorage.getItem(j(this, C))));
  } catch (t) {
    console.warn(t);
  }
  return j(this, q);
...
const Ie = async (t) => {
  const e = await Promise.all(
    t.map(
      (r) => r.request({ type: "wallet_getPermissions" }).then((s) => s.includes(xe.ACCOUNTS)).catch(() => !1)
    )
  );
...
function kt(t = {}) {
  ...
  return {
    ...
    getLastConnectedWallet: async () => {
      ...
      return c || (n.delete(), null);
    },
    enable: async (o, a) => {
      await o.request({
        type: "wallet_requestAccounts",
        params: {
          silent_mode: a == null ? void 0 : a.silent_mode
        }
      });
      const c = await o.request({
        type: "wallet_getPermissions"
      });
      if (!(c != null && c.includes(xe.ACCOUNTS)))
...
const L = kt(), ae = typeof window < "u" ? window : null;
function Nt() {
  var e;
...
const le = async (t, e) => t ? L.enable(t, e).catch(() => null) : null, It = async ({
  modalMode: t = "canAsk",
  storeVersion: e = Nt(),
  modalTheme: r,
  ...s
  ...
  var u, h;
  const n = await L.getAuthorizedWallets({
    ...s
  }), o = await L.getLastConnectedWallet();
  if (t === "neverAsk") {
    const d = (u = n.find((g) => g.id === (o == null ? void 0 : o.id))) != null ? u : n[0];
    return le(d, { silentMode: !0 });
  }
